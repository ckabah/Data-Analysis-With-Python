...
def calculate_demographic_data(print_data=True):
  # Read data from file
  df = pd.read_csv("D:\\Dataset\\adult.data.csv")
  ...
  percentage_bachelors = round((ed_counts['Bachelors']/ed_counts.sum())*100, 1)
  ...
  rich_percentage = round((num_min_workers[df['salary'] == '>50K'].shape[0]/num_min_workers.shape[0])*100, 1)
